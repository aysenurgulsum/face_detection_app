...
import 'package:face_detection_app/util/screen_mode.dart';
...
class _CameraViewState extends State<CameraView>{
  ...
  Widget _galleryBody() => ListView(shrinkWrap: true,
    children: [
      ...
      Padding(padding: const EdgeInsets.symmetric(horizontal: 16.0,), child:
        ElevatedButton(
